...
// Game
router.post('/getChartData', controller.getChartData);
router.get('/getPoint', controller.getPoint);
router.post('/setGame', controller.setGame);
router.post('/getReadyGame', controller.getReadyGame);
router.post('/getRecentResult', controller.getRecentResult);
